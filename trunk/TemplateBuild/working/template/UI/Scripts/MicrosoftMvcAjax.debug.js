...
Sys.Mvc.AsyncHyperlink.handleClick = function Sys_Mvc_AsyncHyperlink$handleClick(anchor, evt, ajaxOptions) {
    ...
    /// </param>
    /// <param name="evt" type="Sys.$safeprojectname$.DomEvent">
    /// </param>
...
Sys.Mvc.MvcHelpers._asyncRequest = function Sys_Mvc_MvcHelpers$_asyncRequest(url, verb, body, triggerElement, ajaxOptions) {
    ...
    if (loadingElement) {
        Sys.$safeprojectname$.DomElement.setVisible(ajaxContext.get_loadingElement(), true);
    }
    if (continueRequest) {
...
Sys.Mvc.MvcHelpers._onComplete = function Sys_Mvc_MvcHelpers$_onComplete(request, ajaxOptions, ajaxContext) {
    ...
    if (ajaxContext.get_loadingElement()) {
        Sys.$safeprojectname$.DomElement.setVisible(ajaxContext.get_loadingElement(), false);
    }
}
